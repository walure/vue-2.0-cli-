export default function bgAnimation(){
		if ( !! document.createElement("canvas").getContext) {
					...
					CAV.Array = "function" === typeof Float32Array ? Float32Array: Array;
					CAV.Utils = {
						isNumber: function(a) {
						...
						for (var a = 0,
						b = ["ms", "moz", "webkit", "o"], c = 0; c < b.length && !window.requestAnimationFrame; ++c) {
					...
					CAV.Vector3 = {
						...
						limit: function(a, b, c) {
							var d = this.length(a);
							null !== b && d < b ? this.setLength(a, b) : null !== c && d > c && this.setLength(a, c);
							return this
						},
						dot: function(a, b) {
					...
					CAV.Plane = function(a, b, c, d) {
						...
						for (a = 0; a < this.segments; a++) {
							for (b = 0; b < this.slices; b++) {
								...
								var t00 = new CAV.Triangle(f, e, g);
								this.triangles.push(t0, t00)
							}
						}
					};
					...
					CAV.CanvasRenderer.prototype.render = function(a) {
						...
						for (b = a.meshes.length - 1; 0 <= b; b--) {
							if (c = a.meshes[b], c.visible) {
								for (c.update(a.lights, !0), d = c.geometry.triangles.length - 1; 0 <= d; d--) {
					...
					if (!window.ActiveXObject && !!document.createElement("canvas").getContext) {
						...
						var w = document.getElementById("canvas_con");
						var D, I, h, q, y;
						var g;
						var r;
						function C() {
